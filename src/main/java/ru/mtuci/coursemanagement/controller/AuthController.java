...
import ru.mtuci.coursemanagement.service.PasswordHashService;
...
public class AuthController {
    ...
    public String doLogin(@RequestParam String username,
        ...
        if (opt.isPresent()) {
            User u = opt.get();
            if (passwords.matches(password, u.getPassword())) {
    ...
    public String register(@RequestParam String username,
        ...
        users.save(new User(null, username, passwords.hash(password), role));
        return "redirect:/login";
    }
}
